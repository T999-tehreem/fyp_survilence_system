...
class OfficerSetting extends StatefulWidget {
  OfficerSetting();

  @override
  OfficerSettingState createState() => new OfficerSettingState();
}

class OfficerSettingState extends State<OfficerSetting> {
                    ...
                    child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                Text(loggedInUser.OfficerName.toString(),
                      ...
                      InkWell(
                        ...
                        child: Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Text(loggedInUser.rank.toString(),
                                    style: MyText.medium(context)
                                        .copyWith(color: MyColors.grey_80)),
                                Text("Rank",
                                    style: MyText.body1(context)!

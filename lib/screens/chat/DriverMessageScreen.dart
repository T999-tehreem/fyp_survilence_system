            ...
            (streamSnapshot
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      if(loggedInUser.name==streamSnapshot.data?.docs[index]['users'][0]){
                        if(user!.uid==streamSnapshot.data?.docs[index].id.split("_")[1]){
                          createChatRoomAndStartConversation(streamSnapshot.data?.docs[index]['users'][1],loggedInUser.name.toString(),
